---
title: Configure Social Forge 
updatedAt: 2025-05-09
summary: Connect Azure Active Directory to Social Forge so your team signs in with existing corporate credentials.
author: codehagen
categories:
  - analysis
slug: azure-saml-sso
...
<Note variant="success">
  SAML single sign-on is available on Social Forge Scale and Enterprise plans.
</Note>

Social Forge Scale customers can enforce single sign-on through Azure Active Directory using the SAML 2.0 protocol. The steps below walk through the Azure configuration and the fields Social Forge expects.
...
In the next screen, click on **Create your own application**. Give your application a **Name** (e.g. "Social Forge") and click **Create**.
...
Scroll down to the 3rd section on the page, **SAML Certificates**. Copy the **App Federation Metadata Url** value—Social Forge uses it to keep your certificate in sync.
...
## Step 5: Configure SAML SSO on Social Forge

In your Social Forge workspace, open **Settings → Security**.

<Image
  alt="SAML SSO section on the Social Forge dashboard"
...
Under **SAML Single Sign-On**, click **Configure**. This opens the Social Forge SSO modal:
...
Your assigned users should now receive an invitation email to join your Social Forge workspace.
...
<Note variant="warning">
  ...
  invitation email and be able to join your Social Forge workspace.
</Note>

They will also be able to sign in to Social Forge using Azure AD SSO.
